...
public class ManualSyncConfirmation extends AbstractDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sync_confirmation, container, false);
    }
                    ...
                    case MotionEvent.ACTION_CANCEL:
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                dismiss();
                                Intent syncIntent = new Intent(getActivity(), ManualSyncActivity.class);
